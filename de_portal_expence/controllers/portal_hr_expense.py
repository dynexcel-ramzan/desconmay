...
class CreateApproval(http.Controller):
    ...
    def create_expenses(self, **kw):
        ...
        if employee.emp_type !='permanent':
            contract_sal = request.env['hr.contract'].search([ ('employee_id','=', employee.id),('state' ,'=', 'open') ])
            if contract_sal:
    ...
    def create_expenses_lines(self, **kw):
        ...
        if expense_sheet.employee_id.emp_type !='permanent':
            contract_sal = request.env['hr.contract'].search([ ('employee_id','=', expense_sheet.employee_id.id),('state' ,'=', 'open') ])
            if contract_sal:
